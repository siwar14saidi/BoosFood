                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Table Special Food</h4>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <?PHP   
                                    ...
                                    $query = "SELECT * FROM  tableSpecialFood ";
                                 ...
                                 echo ' <table id="books" class="table">   
                                   ...
                                   <td><img src="../controle/uploads/'.$row['image'].'" alt="." height="75" width="75"></td>
                                                   <td>'.$row["name"].'</td> 
                                                   <td>'.$row["price"].' $</td> ';?>
                                                   <td> <a   href="../controle/tableSpecialFood.php?event=delete&&idFood=<?php echo''.$row["id"].'';  ?>" class="btn btn-danger"> <i class="far fa-trash-alt"></i> </a></td> 
                                                   <td>  <a href="editSpecialFood.php?id=<?php echo''.$row["id"].''.$row["image"].''.$row["name"].''.$row["price"].'';  ?>  " class="btn btn-warning"><i class="far fa-edit"></i></a></td> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <form method="POST" action="../controle/tableSpecialFood.php?event=add" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-2">
