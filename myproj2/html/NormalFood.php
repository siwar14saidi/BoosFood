...
<html lang="en">
    <head>
        ...
        <link href="css/NormalFood.css" rel="stylesheet" />
    ...
    <body id="page-top">
            ...
            <img src="../images/LogoBossFoodddd.svg" width="290px" >   
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                      ...
                      <li><a href="ShoppingCard.php"  style="color:  #fff;"><i class="font fa fa-shopping-cart fa-1x" style="color:  #fff; "></i> shopping card
        ...
        <header class="masthead">
            <div class="container">
                <div class="font" style="font-size: 40px; margin-right: 100px;margin-block-end: 85px;">Normal Food</div>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                ...
                <h2 class="font2 section-heading text-uppercase">List Of The Normal Food</h2>
                    <br>
                </div>
                <div class="row">
                    <?PHP   
